---
id: intelligence-outside-your-head
number: "04"
part: II
stage: 3
partTitle: What Are We?
title: The Intelligence Outside Your Head
deck: Thinking becomes larger when the world is allowed to carry part of the load.
runningHead: Intelligence Outside
readingTime: 6
spreads:
  - type: opener
    variant: facing
    image: intelligence-01-pencil-mark
    blocks: [open]
  - type: reading
    variant: two
    dropCap: true
    blocks: [flow-1a, flow-1b]
    bandImage: intelligence-02-cards-table
    ground: ground-04-extended-cognition
    marginNote: >-
      Under conditions that block rehearsal and grouping, research on working
  ...
  - type: reading
    ...
    bandImage: intelligence-04-route-line
    marginNote: >-
      In a 2000 MRI study, licensed London taxi drivers had more gray-matter
      volume in the posterior hippocampus than controls. The difference
      correlated with years spent navigating, evidence that repeated use can
      alter the brain’s spatial system.
  - type: image-essay
    variant: tall
    image: intelligence-05-tools-ready
    blocks: [flow-2c]
    caption: >-
    ...
    hand: held by the room
  - type: reading
    variant: aside
    blocks: [flow-3a, flow-3b]
    marginNote: >-
      Four experiments published in 2011 found that people expecting later
      computer access recalled the location of information better than the
      information itself. Memory had not disappeared. Part of the task had
      shifted toward retrieval.
    notice: >-
