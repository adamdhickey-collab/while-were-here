---
id: last-generation-before-time
number: "06"
part: III
stage: 4
...
spreads:
  - type: opener
    variant: facing
    image: before-time-01-road-atlas
    blocks: [open]
  - type: reading
    variant: two
    dropCap: true
    blocks: [flow-1a, flow-1b]
    bandImage: before-time-02-answering-machine
  ...
  - type: reading
    ...
    bandImage: before-time-04-waiting-clock
    marginNote: >-
  ...
  - type: image-essay
    ...
    blocks: [flow-2c]
    caption: >-
      <b>Figure 5.</b> Things that did one thing each. Every function here now
      lives in a single object in a pocket.
    sidebar:
      title: Field notes
      lines:
  ...
  - type: reading
    ...
    marginNote: >-
      The first SMS message was sent from a computer on December 3, 1992.
      Early text messages carried a 160-character limit, a technical boundary
      that helped shape a new compressed style of writing.
    notice: >-
