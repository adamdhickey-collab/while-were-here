...
spreads:
  - type: opener
    variant: facing
    image: privilege-01-kitchen-laptop
    blocks: [open]
  - type: reading
    variant: two
    dropCap: true
  ...
  - type: reading
    ...
    bandImage: privilege-04-two-reviewing
    marginNote: >-
  ...
  - type: image-essay
    ...
    blocks: [flow-2c]
    caption: >-
      <b>Figure 4.</b> The dog under the desk. Whatever is happening above her
      is, from the floor, a Tuesday.
    sidebar:
      title: Field notes
      lines:
  ...
  - type: reading
    ...
    marginNote: >-
      AlphaFold’s public database provides over 200 million predicted protein
      structures. Experimental structures still matter, but researchers gained
      a computational starting point at a scale no laboratory could produce
