...
# Essay 03 — The Beauty of Systems Nobody Designed
...
When the draft comes back, save it as `content/essays/systems-nobody-designed.md`, add it to
...
`ground-03-local-rules-flocking` — see `prompts/outstanding-brief.md`.
...
**The essay you are drafting is: The Beauty of Systems Nobody Designed, in Part II, What Are We?.**

Stage II, "notice the patterns". Bone ground, still light. Denser than Part I but not yet dark.
