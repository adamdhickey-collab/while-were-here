...
# Essay 04 — The Intelligence Outside Your Head
...
When the draft comes back, save it as `content/essays/intelligence-outside.md`, add it to
...
`ground-04-extended-cognition` — see `prompts/outstanding-brief.md`.
...
**The essay you are drafting is: The Intelligence Outside Your Head, in Part II, What Are We?.**
