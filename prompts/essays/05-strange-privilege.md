<!-- GENERATED by `npm run draft`. Edit content/plan/drafting-brief.md, not this file. -->

# Essay 05 — The Strange Privilege of Being Alive During a Technological Revolution
...
When the draft comes back, save it as `content/essays/strange-privilege.md`, add it to
...
`ground-05-imagine-to-make` — see `prompts/outstanding-brief.md`.
...
**The essay you are drafting is: The Strange Privilege of Being Alive During a Technological Revolution, in Part III, The World Is Changing.**

Stage III, "enter the systems". **The page inverts to a charcoal ground and the type reverses out.** Write knowing the reader is inside something rather than looking at it.
