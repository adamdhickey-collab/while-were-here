...
# Essay 06 — The Last Generation That Remembers the Before-Time
...
When the draft comes back, save it as `content/essays/before-time.md`, add it to
...
`ground-06-density-thinning` — see `prompts/outstanding-brief.md`.
...
**The essay you are drafting is: The Last Generation That Remembers the Before-Time, in Part III, The World Is Changing.**

Stage IV, "expand awareness". **A dark ground, and the most vivid pages in the book.** This is the peak of the arc, so it is the one essay allowed to be the loudest.
