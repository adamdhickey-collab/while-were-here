...
# Essay 07 — Why Humans Need Pilgrimages
...
When the draft comes back, save it as `content/essays/pilgrimages.md`, add it to
...
`ground-07-convergent-routes` — see `prompts/outstanding-brief.md`.
...
**The essay you are drafting is: Why Humans Need Pilgrimages, in Part IV, While We’re Here.**

Stage V, "return with wonder". Warm paper again, calmer, fewer elements. It has to earn its quiet by following the dark pages, not by avoiding what they said.
