...
When the draft comes back, save it as `content/essays/while-were-here.md`, add it to
...
`ground-08-nested-systems` — see `prompts/outstanding-brief.md`.
...
**The essay you are drafting is: While We’re Here, in Part IV, While We’re Here.**
